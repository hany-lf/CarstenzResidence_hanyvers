      ...
      <View style={{ alignItems: "center", justifyContent: "center" }}>
        ...
        >
          <TouchableOpacity
            ...
            onPress={handlePress}
          >
            {/* onPress={() => navigation.navigate('RenovPermit')}> */}
            ...
            {isExpanded && (
              <View style={styles.additionalContent}>
                ...
                <View style={{ marginHorizontal: 70, alignItems: "center" }}>
                  <TouchableOpacity
                    style={styles.buttonAttach}
                    onPress={() => navigation.navigate("AttachRenov")}
                  >
                    <Text style={styles.fontAttach}>Letter of Permit</Text>
                  </TouchableOpacity>
                </View>
              </View>
            )}
